...
use app\modules\sam\models\NcrSearch;
...
class NcrController extends Controller
{
    ...
    {
        $model = $this->findModel($id);
        $model->todepartmentToArray();
        $model->problemToArray();
    ...
    {
        $uploadPath   = Ncr::getUploadPath() . '/' . $folderName . '/';
    ...
    public function actionDeletefileAjax()
    {
        ...
        if ($model !== NULL) {
            $filename  = Ncr::getUploadPath() . $model->ref . '/' . $model->real_filename;
            $thumbnail = Ncr::getUploadPath() . $model->ref . '/thumbnail/' . $model->real_filename;
            if ($model->delete()) {
                @unlink($filename);
                @unlink($thumbnail);
                echo json_encode(['success' => true]);
